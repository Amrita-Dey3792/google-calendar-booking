...
function GoogleCalendarEmbed() {
  ...
  const calendarLink = "https://calendar.google.com/calendar/u/0/appointments/schedules/AcZssZ1eP6JMKEaRfb0o9qYMqJ0opDkjJu0h5pynihAnEoU5J9KlDJaSLK_fNPlG1nTK4kP7WnYbfwcX?gv=true"; // Google Calendar link
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-r from-blue-400 via-indigo-500 to-purple-600 text-white p-5">
      ...
      <p className="text-xl mb-6">Schedule a time that works best for you. Click the button below to open the calendar.</p>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg w-11/12 md:w-2/3 lg:w-1/2 p-6">
            <h2 className="text-3xl font-semibold text-center mb-4">Select a Time</h2>
            <iframe
              src={calendarLink}
              width="100%"
              height="500"
